...
public class ConsumerConfig {
    ...
    public ConsumerFactory<String, PatternEvent> livePriceEventConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        ...
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(PatternEvent.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PatternEvent> livePriceEventKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, PatternEvent> factory = new ConcurrentKafkaListenerContainerFactory<>();
